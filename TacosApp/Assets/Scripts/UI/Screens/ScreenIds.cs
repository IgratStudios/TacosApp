...
//clase para controlar los ids de las pantallas y accederlospor igual en todos los scripts que lo necesiten
public static class ScreenIds 
{
	...
	public const string sMenuScreen = "Menu";
	public const string sTablesScreen = "Tables";
	public const string sStatsScreen = "Statistics";
